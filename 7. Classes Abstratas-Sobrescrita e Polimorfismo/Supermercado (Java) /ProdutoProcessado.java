public abstract class ProdutoProcessado extends Produto {
    ...
    public ProdutoProcessado(String nome, int qtdProduzida, 
        double custoMateriaPrimaPorQtd, double custoFuncionario) {
        super(nome);
    ...
    @Override
    public double custo() {
        return (this.qtdProduzida * this.custoMateriaPrimaPorQtd) 
        + this.custoFuncionario;
    }
